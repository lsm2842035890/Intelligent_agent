...
from train_agent_env_s_d import D2RLTrainingEnv
import yaml, argparse
from tqdm import tqdm
import json

parser = argparse.ArgumentParser()
parser.add_argument('--yaml_conf', type=str, default=r'C:\Users\28420\Desktop\SAIC\Dense-Deep-Reinforcement-Learning-main\sumo_data_agent_train\train_s_d.yaml', metavar='N',
...
# 这段代码的作用是在 Ray 中初始化运行时环境，并根据参数配置选择是否启动仪表板，并在已初始化的情况下忽略重新初始化错误
            ...
            with open(crash_data_path) as crash_data:
                ...
                if crash_data_json["weight_episode"] < 0.1:
                    crash_weight_dict[crash_data_path] = [crash_data_json["weight_episode"],
                                                          crash_data_json["weight_episode"]]
